...
/// "zfs" | "other"`.
///
/// macOS (`APFS`, `HFS+`) and Linux native (`ext4`, `btrfs`, `xfs`,
/// `zfs`) are 2026-06-08 platform-completeness additions: pre-fix
/// every honest non-Windows submission collapsed to `"other"`
/// because the engine's mapper + the live submit schema enum
/// recognised only NTFS / ReFS / exFAT / FAT32 / network-SMB. Web
/// shipped the schema bump at `47b4419` (2026-06-08 16:35 PDT); this
/// commit flips the deferred mapper arms to literal emission.
///
